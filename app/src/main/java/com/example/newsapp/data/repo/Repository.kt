    ...
    private val apiService: ApiService
     ...
     override  fun getArticles(
         ...
         val pagingSourceFactory = {
             when (query) {
                 is ApiQuery.GetAll -> newsDataBase.NewsDao().getArticlesOrderByDate(category!!)
         ...
         return Pager(config = PagingConfig(pageSize = NETWORK_PAGE_SIZE, enablePlaceholders = false),
                 remoteMediator = NewsRemoteMediator(query,country,language,category,apiService,newsDataBase),
